...
export class DashboardComponent implements OnInit {
   ...
   * Reposável por chamar os métodos geradores dos gráficos
   * 
   * @return void
   */
  exibirGraficos(): void{
  ...
  /**
   * 
   * @returns Exibe o gráfico Donut Chart
   * 
   * @return void
   */
  ...
  obterOpcoes(): any {
    return {
      'ttile': 'Quantidade de cadastros primeiro semestre',
      'width': 400,
      'height': 300
    }
  }
